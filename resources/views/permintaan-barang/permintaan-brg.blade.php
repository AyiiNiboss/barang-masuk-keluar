                ...
                <div class="card-body">
                    <div class="mb-3">
                        <div class="header-left">
                            <a href="/permintaan-barang/add" class="btn btn-success btn-sm" title="Tambah Data">Form Permintaan Barang</a>
                        </div>
                    </div>
                    {{-- modal tambah data--}}
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/permintaan-barang/detail/{{ $row->tgl_permintaan }}" class="btn btn-warning" title="Detail Permintaan"><i class="ti-eye"></i></a>
                                    </td> 
                                </tr>
                                @endforeach
                            </tbody>
